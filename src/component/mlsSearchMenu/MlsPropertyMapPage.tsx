        ...
        >
          ...
          >
            {isLoading ? (
                    ...
                    {Array.from({ length: 4 }).map((_, i) => (
                      ...
                      >
                        ...
                        <div className="p-5 flex flex-col gap-2.5">
                          <div className="h-6 w-32 bg-[var(--line-medium)]" />
                          <div className="h-3 w-full bg-[var(--canvas-2)]" />
                          <div className="h-3 w-3/4 bg-[var(--canvas-2)]" />
                          <div className="h-px bg-[var(--line-medium)] my-1" />
                          <div className="h-3 w-1/2 bg-[var(--canvas-2)]" />
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <div className="flex flex-col items-center text-center py-24 text-[var(--ink-faint)]">
