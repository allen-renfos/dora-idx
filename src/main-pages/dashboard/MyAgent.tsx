    ...
    return (
        <main className="flex-1 p-10 bg-[#171717] min-h-screen main-content-p ">
            ...
            <div className="flex justify-between items-center mb-8 content-border 
                    border-[#3B3B3B] p-4 rounded-none ">
                <p className="font60 font-sans font-semibold text-shadow-none">
                    My Agent
                </p>
                <button className="flex padding2 items-center gap-2 bg-[#EDB75E] text-white px-6 py-2 rounded-none font-semibold hover:bg-[#e0a94e] transition">
                    {/* <FaPlus /> */}
                    <Image
            ...
            <div className=" p-2 flex flex-row w-full justify-center gap-2 ">
                <div className="flex flex-col flex-1">
                    <div className="flex-1 flex flex-col gap-4 bg-[#000000] paddingB5
                     border border-[#3B3B3B] rounded-none  items-start">
                        <div className="flex w-full mb-8 content-border border-[#3B3B3B] p-4 rounded-none 
                        items-left padding2 mb0">
                            <p className="font20 font-sans font-semibold text-shadow-none">
                                About Bio
                            </p>
                        </div>
                        <div className="flex w-full gap-4 padding2">
                            <div className="flex flex-col max-w-1/2">
                                ...
                                <p className="font14 font-sans font-semibold text-shadow-none">
                                    RealtiPro Platform
                                </p>
                            ...
                            <div className="flex flex-col flex-1 ">
                                <p className="font16 font-sans font-semibold text-shadow-none text-justify">
                                ...
                                <p className="font16 font-sans font-semibold text-shadow-none text-justify paddingT5">
                ...
                rounded-none  items-start marginTop">
                        ...
                        <div className="flex flex-col items-start w-full pl-[5px] paddingLeft3 padding2">
                            <p className="font16 font-sans">Subject</p>
                            <input className="font14 font-sans marginTop15
                             text-shadow-none border border-[#4E4E4E] rounded-none padding2 w-full"
                                placeholder="Write your subject" />
                        </div>
                        <div className="flex flex-col items-start w-full pl-[5px] paddingLeft3 padding2">
                            <p className="font16 font-sans">Message</p>
                            <input className="font14 font-sans  h-[150px] marginTop15
                             text-shadow-none border border-[#4E4E4E] rounded-none padding2 w-full"
                    ...
                    text-white px-6 py-2 rounded-none font-semibold hover:bg-[#e0a94e] 
                    transition mt10">
                                Send
                            </button>
                        </div>
                ...
                items-center flex-col">
                    ...
                    rounded-none items-left padding2 mb0">
                        ...
                        <p className="font20 font-sans content-center font-semibold text-shadow-none">
                            George Jhon
                        </p>
                    </div>
                    ...
                    font-semibold text-shadow-none">
                        ...
                        <p className="font16 font-sans  content-center text-[#ADADAD]
                    font-semibold text-shadow-none">
                    ...
                    <div className=" border-t border-[#3B3B3B] bg-[#000000] padding2 bottom-border">
                        <div className="flex items-center gap-1 padding2">
                            {/* Attachment Button */}
                            <button
                                className=" rounded-none  border-2 border-[#EDB75E] 
                            ...
                            <input
                                ...
                                rounded-none px-4 py-3 text-white placeholder-[#ADADAD]
                            ...
                            <button
                                ...
                                className="bg-[#EDB75E]  padding1 text-white px-6 py-3 rounded-none font-semibold hover:bg-[#e0a94e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                            >
            ...
            <div className="marginTop rounded-none p-8 min-h-[200px] flex flex-row  w-full justify-center 
                ...
                <div className="flex-3 text-left padding2 paddingRight10 ">
                    <div className="flex-1 w-full mt5">
                        <button className="flex p-8 items-center gap-3 bg-[#171717] border 
                            border-[##4E4E4E] text-[#4C4C4C] rounded-none  text-center w-full
                ...
                gap-3 bg-[#EDB75E] text-black rounded-none text-center w-full
